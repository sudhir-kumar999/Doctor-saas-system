  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await api.post("/api/appointment/book", {
        ...
        time,
        reason,
        fees: doctor?.fees || 500, // doctor fees pass karna
      });

      const createdAppointmentId = res.data.appointment._id;
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 lg:p-8 border border-gray-100">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {date && time && (
              <div className="bg-blue-50 border-2 border-blue-200 rounded-lg p-4">
                ...
                <div className="space-y-1 text-sm text-blue-800">
                  ...
                  <p>
                    👨‍⚕️ <strong>Doctor:</strong> Dr. {doctor?.name}
                  </p>
                </div>
              </div>
            )}
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              <button
                type="submit"
                disabled={loading || !date || !time || showPayment}
                className={`
          ...
          {showPayment && appointmentId && (
            <div className="mt-6 bg-green-50 border-2 border-green-200 rounded-lg p-6 text-center">
              ...
              <p className="mb-4 text-green-800">
                Appointment created successfully. Please complete payment to
                confirm booking.
              </p>
        ...
        <div className="mt-6 bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-r-lg">
          <div className="flex">
            ...
            <div className="text-sm text-yellow-800">
              ...
              <p>
                Your appointment request will be sent to the doctor for
